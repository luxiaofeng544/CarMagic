package com.lemon.carmonitor.component;
...
import com.lemon.util.DensityUtils;
...
//        colorControlNormal = materialStyledAttrs.getColor(0, appcompatMaterialStyledAttrs.getColor(0, R.color.holo_blue_dark));
//        colorControlHighlight = materialStyledAttrs.getColor(1, appcompatMaterialStyledAttrs.getColor(1, R.color.black));

        /*targetColor = colorControlNormal;
        insideRangeColor = colorControlHighlight;*/

        targetColor = R.color.holo_blue_dark;
        insideRangeColor = R.color.black;
